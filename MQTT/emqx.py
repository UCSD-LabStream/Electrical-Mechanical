...
#client.ws_set_options(path="/mqtt")  # Only if required by the broker
#client.tls_set()  # Uncomment if using TLS
#client.tls_insecure_set(True)  # Uncomment if you want to skip certificate verification
